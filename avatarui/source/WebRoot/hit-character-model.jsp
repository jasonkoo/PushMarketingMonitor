...
<div class="wrap">
	<div class="crumb">
				<h1><span id="ReportAnchor"></span> 设备型号</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="设备型号" id="reportTypeCnName"/>
				<input type="hidden" value="DeviceModel" id="reportTypeEnName"/>
			</div>
			<div class="filterOpt">
			...
			<div class="maxTable">
				<div class="tableControl">
					...
					<div style="float:left; margin:3px 0 0 15px; line-height:25px;">设备型号：</div>
