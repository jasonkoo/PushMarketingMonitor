...
<body data-main="script/sdk/feedbackanalysis/sdkUser.js?20131223">

<div class="wrap">
		<div class="crumb">
				<h1><span id="ReportAnchor"></span> 下载错误</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="下载错误" id="reportTypeCnName"/>
				<input type="hidden" value="ErrorDownload" id="reportTypeEnName"/>
			</div>
			...
			<div class="filterOpt">
	 		...
	 		<div class="globalTab">
				<ul>
					<li index="error_pv" class="selected"><a href="javascript:;">下载错误量</a></li>
					<li index="error_uv"><a href="javascript:;">下载错误用户量</a></li>
				</ul>
			</div>
