...
<div class="wrap">
		<div class="crumb">
				<h1><span id="ReportAnchor"></span> 安装错误</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="安装错误" id="reportTypeCnName"/>
				<input type="hidden" value="ErrorInstall" id="reportTypeEnName"/>
			</div>
			...
			<div class="filterOpt">
	 		...
	 		<div class="globalTab">
				<ul>
					<li index="error_pv" class="selected"><a href="javascript:;">安装错误量</a></li>
					<li index="error_uv"><a href="javascript:;">安装错误用户量</a></li>
				</ul>
			</div>
