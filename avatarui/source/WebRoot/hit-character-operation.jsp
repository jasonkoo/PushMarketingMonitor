...
<div class="wrap">
	<div class="crumb">
				<h1><span id="ReportAnchor"></span> 网络运营商</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="网络运营商" id="reportTypeCnName"/>
				<input type="hidden" value="Operator" id="reportTypeEnName"/>
			</div>
			<div class="filterOpt">
			...
			<div class="maxTable">
				<div class="tableControl">
					...
					<div style="float:left; margin:3px 0 0 15px; line-height:25px;">网络运营商：</div>
