...
<div class="wrap">
	<div class="crumb">
				<h1><span id="ReportAnchor"></span> 版本分布</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="版本分布" id="reportTypeCnName"/>
				<input type="hidden" value="EngineVersion" id="reportTypeEnName"/>
			</div>
			<div class="filterOpt">
			...
			<div class="maxTable">
				<div class="tableControl">
					...
					<div style="float:left; margin:3px 0 0 15px; line-height:25px;">版本：</div>
