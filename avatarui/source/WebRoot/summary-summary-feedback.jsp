...
<body data-main="script/sdk/sdkInterview-feedback.js?20140219">

        <div class="crumb">
            <h1><span id="ReportAnchor"></span> 反馈概况数据</h1>
   ...
   -->        
        ...
        <div style="position:relative;">
            <div class="sdkTabs sdkTabsTrend" id="TrendTab">
                <ul>
                    <li index="0" class="active first"><a href="javascript:;">到达</a></li>
                    <li index="1"><a href="javascript:;">展现</a></li>
                    <li index="2"><a href="javascript:;">点击</a></li>
                    <li index="3"><a href="javascript:;">二次展现</a></li>
                    <li index="4"><a href="javascript:;">二次点击</a></li>
                    <li index="5"><a href="javascript:;">下载</a></li>
                    <li index="6"><a href="javascript:;">安装</a></li>
                    <li index="7" class="last"><a href="javascript:;">激活</a></li>                    
                </ul>
                ...
                <div style="float:left; line-height:24px; font-size:14px;">
                    ...
                    <div class="normSelect" id="NormSelect1">
                        ...
                        <ul id="DropDownMenuChannel" class="dropDownMenu">
                            ...
                            <li><a href="javascript:;" value="arrived">到达</a></li>
                            <li><a href="javascript:;" value="displayed">展现</a></li>
                            <li><a href="javascript:;" value="sysmsgclicked">点击</a></li>
                            <li><a href="javascript:;" value="s2nddisplayed">二次展现</a></li>
                            <li><a href="javascript:;" value="s2ndclicked">二次点击</a></li>
                            <li><a href="javascript:;" value="downloaded">下载</a></li>
                            <li><a href="javascript:;" value="installed">安装</a></li>
                            <li><a href="javascript:;" value="activated">激活</a></li>                                                                                   
                        </ul>
                    </div>
        ...
        <div id="TimeTrendWrap" style="position:relative; margin-top:-10px;">
            ...
            <div id="TimeTrendCon" style="position:relative;">
                <div class="sdkTabs" id="TimeTrendTab">
                    <ul>
                        <li id="Arrived" class="first active" >到达</li>
                        <li id="Displayed">展现</li>
                        <li id="SysmsgClicked">点击</li>
                        <li id="S2ndDisplayed">二次展现</li>
                        <li id="S2ndClicked">二次点击</li>
                        <li id="Downloaded">下载</li>
                        <li id="Installed">安装</li>                        
                        <li id="Activated" class="last" >激活</li>                                            
                    </ul>
