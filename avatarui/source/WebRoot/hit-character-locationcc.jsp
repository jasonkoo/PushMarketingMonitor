...
<div class="wrap">
		<div class="crumb">
				<h1><span id="ReportAnchor"></span> 地理位置（省级）</h1>
				<span class="reportTimeTip">本报表为即席查询，支持实时数据查询</span>
				<input type="hidden" value="地理位置（省级）" id="reportTypeCnName"/>
				<input type="hidden" value="LocationCC" id="reportTypeEnName"/>
			</div>
			...
			<div class="filterOpt">
	 		...
	 		<div class="globalTab">
				<ul>
					<li index="hit_pv" class="selected"><a href="javascript:;">投放量</a></li>
			...
			<div class="maxTable">
				<div class="tableControl">
					...
					<div style="float:left; margin:3px 0 0 15px; line-height:25px;">地理位置：</div>
